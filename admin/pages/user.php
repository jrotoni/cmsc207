...
if ($idText == 0 ) {
$sql = "SELECT *
        FROM id4782439_cmsc.tbl_user u, id4782439_cmsc.tbl_category_user c
		WHERE last_name like ('$searchText%')
		AND u.cat_id = c.cat_id  $sql2
		ORDER BY last_name";
}else{
$sql = "SELECT *
        FROM id4782439_cmsc.tbl_user u, basic.tbl_category_user 	
...
?>
                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
								...
								//echo $instr_firstname;
								//exit;
								$instr_lastname = utf8_encode($instr_lastname);
								$instr_firstname = utf8_encode($instr_firstname);
								?>
                                 <tr class="gradeA">
                                        <td>
					...
					<?php echo $last_name . ', ' . $first_name; ?></a></td>
										...
										<td width="12%" align="center"><a class="delete" href="javascript:deleteCS('<?php echo $user_id; ?>');">DELETE</a></td>
                                    </tr>
